<template>
	<view>
		...
		<uni-section title="就业创业" type="line">
			<view class="carceerdInfo">
				<view class="carceerdMoreIcon" @click="articleMore('就业创业')">查看更多
				...
				<template v-slot:cover>
					<view class="custom-cover" @click="goHotDetail">
						...
						<view class="cover-content">
							<text class="uni-subtitle uni-white">最新创业热点指导</text>
						</view>
					</view>
				</template>
				<uni-list>
					<view v-for="(value, key) in listCareerData" :key="key" @click="goCareerDetail(value)">
						<uni-list-item :title="value.title" showArrow></uni-list-item>
					</view>
				</uni-list>
			</uni-card>
		</uni-section>
		<uni-section title="校园招聘" type="line">
			<view class="carceerdInfo">
				<view class="carceerdMoreIcon" @click="articleMore('校园招聘')">查看更多
					<uni-icons type="right" size="20"></uni-icons>
				</view>
				<view style="background-color: #eee; width: 100%; height: 1rpx;"></view>
			</view>
		...
		methods: {
			...
			goCareerDetail: function(e){
				let detail = {
					...
					title: e.title,
					source: 'XXX官方信息',
					avatar: 'https://mp-7b604e11-5098-4a9b-880c-4658d63b9294.cdn.bspapp.com/images/xyzp.png',
					note: '这是注释',
					pub_at: '2023-07-17'
				};
				uni.navigateTo({
